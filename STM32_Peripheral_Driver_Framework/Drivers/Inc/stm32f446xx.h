...
#define GPIOH  				((GPIO_TypeDef_t*) GPIOH_BASEADDR)

#define RCC 				((RCC_TypeDef_t*) RCC_BASEADDR)
#define EXTI				((EXTI_TypeDef_t*) EXTI_BASEADDR)
#define SYSCFG				((SYSCFG_TypeDef_t*) SYSCFG_BASEADDR)

#define SPI1  				((SPI_TypeDef_t*) SPI1_BASEADDR)
#define SPI2  				((SPI_TypeDef_t*) SPI2_BASEADDR)
#define SPI3  				((SPI_TypeDef_t*) SPI3_BASEADDR)
#define SPI4  				((SPI_TypeDef_t*) SPI4_BASEADDR)

#define USART1  			((USART_TypeDef_t*)USART1_BASEADDR)
#define USART2  			((USART_TypeDef_t*)USART2_BASEADDR)
#define USART3  			((USART_TypeDef_t*)USART3_BASEADDR)
#define UART4  				((USART_TypeDef_t*)UART4_BASEADDR)
#define UART5  				((USART_TypeDef_t*)UART5_BASEADDR)
#define USART6  			((USART_TypeDef_t*)USART6_BASEADDR)

#define I2C1  				((I2C_TypeDef_t*)I2C1_BASEADDR)
#define I2C2  				((I2C_TypeDef_t*)I2C2_BASEADDR)
#define I2C3  				((I2C_TypeDef_t*)I2C3_BASEADDR)
...
/********************************* SPI Registers Bit position Definition Macros *******************/

/*
 * SPI_CR1 Bit Definition Macros
 */
...
/********************************* USART Registers Bit position Definition Macros *******************/
...
/********************************* I2C Registers Bit position Definition Macros *******************/
/*
